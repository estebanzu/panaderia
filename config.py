...
ESTADOS_ACTIVOS = [ESTADO_PENDIENTE, ESTADO_CONFIRMADO,ESTADO_PREPARACION, ESTADO_LISTO, ESTADO_RUTA,ESTADO_CANCELADO]

FLOW_ESTADOS = {
    ESTADO_PENDIENTE: ESTADO_CONFIRMADO,
    ESTADO_CONFIRMADO: ESTADO_PREPARACION,
    ESTADO_PREPARACION: ESTADO_LISTO,
    ESTADO_LISTO: ESTADO_RUTA,
    ESTADO_RUTA: ESTADO_ENTREGADO
}
